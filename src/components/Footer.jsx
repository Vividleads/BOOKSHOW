     ...
     <footer className='relative bg-gradient-to-b from-gray-900 to-gray-900/95 backdrop-blur-2xl border-t border-t-gray-800'>
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-18'>
            <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8'>
                ...
                <div className='space-y-4 text-center sm:text-left'>
                   ...
                   <ul className='space-y-3'>
                     {['Trending', 'New Releases','Genres', 'Authors'].map((item) => (
                        <li key={item}>
                            <a href="#" className='text-gray-600 hover-text-cyan-300 text-sm
                ...
                <div className='space-y-4 text-center sm:text-left'>
                   ...
                   <div className='flex flex-wrap gap-3 justify-center sm:justify-start'>
                      {['React', 'tailwind', 'vite', 'GoogleApi'].map((tech) => (
                        <span className='px-3 py-3.5 cursor-pointer rounded-full bg-gray-800/30 text-gray-300 text-sm
                        backdrop-blur-sm hover:bg-cyan-400/20 hover:text-cyan-300 transition-all'
                        key={tech} >
                          {tech}
                        </span>
                      ))}
                    ...
                    <div className='mt-4 space-y-2 '>
                        ...
                        <GlobeAltIcon className='h-5 w-5 '/>
                           <span className='text-sm'>Global Book Defense</span>
                        </div>
                    </div>
                </div>
                {/* my social links */}
                   ...
                   <div className='flex justify-center sm:justify-start space-x-4'>
                      {[
                        ...
                        ['Instagram', 'hover:text-pink-300', Instagram],
                         ...
                         <a href='#'
                          key={platform}
                          className={` text-gray-400 ${className} transition-colors hover:scale-120`}>
              ...
              {/* COPYRIGHT */}
            <div className='border-t border-gray-800 mt-12 pt-3 text-center'>
                <p className='text-gray-500 text-sm '>
                   &copy; {new Date().getFullYear()} BOOKSHOW. All stories belong to their respective authors
                </p>
                 <p className='text-gray-500 text-sm '>
                  Powered By{''}
                  <a href="https://github.com/Vividleads"
                  target='blank' className='bg-clip-text text-transparent bg-gradient-to-r from-purple-400
                  to-blue-400 hover:text-purple-600 transition-colors'>
                    Vividleads by David Peter
                  </a>
                 </p>
