     ...
     <div className="container mx-auto px-4 h-screen flex items-center ">
       <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-full">
           ...
           <div className="lg:col-span-1 flex flex-col justify-center space-y-6">
              ...
              className="text-4xl sm:text-5xl md:text-6xl font-bold bg-gradient-to-r from-cyan-400 to-blue-500
              bg-clip-text text-transparent  ">
                  Interactive Library 
              </motion.h1>
              <motion.p inital={{opacity:0}}
              animate={{opacity:1}}
              ...
              whileTap={{scale:0.95}}
              onClick={() => document.getElementById('hero').scrollIntoView({behaviour:'smooth'})}
              className="bg-gradient-to-r from-cyan-500 to-blue-600 w-fit px-8 py-3 rounded-full
              font-bold text-white shadow-lg hover:shadow-cyan-500/30 transition-all ">
                Start Exploring
              </motion.button>
           </div>

           {/* IMAGE CONTAINER */}
           <div className="md:col-span-1 lg:col-span-2 h-64 sm:h-80 md:h-[600px] relative
